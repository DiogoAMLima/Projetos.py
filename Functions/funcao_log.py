def log():
    ...
    print(f'O resultado do log \033[31m{logaritmo}\033[m na base \033[34m{log_base}\033[m é: '
          f'\033[37m{math.log(logaritmo, log_base)}\033[m')
    print()
    logaritmo2 = float(input('Informe mais um número para saber o log na base 10: '))
    print(f'O resultado do log \033[32m{logaritmo2}\033[m na base 10 é: \033[36m{math.log10(logaritmo2)}\033[m')
    print()
    logaritmo3 = float(input('Informe outro número para saber o log na base 2: '))
