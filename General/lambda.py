...
for i in range(1, 5):  # Looping (usar o for quando souber quando parar)
...
# Lambda é uma função anônima, bom quando não é preciso reutilizar a função, apenas no momento
# Pode ter apenas uma expressão e receber qualquer quantidade de argumentos
