...
if confronto == 1:
    ...
    if aleatorio_2 == 1:
        print('\nSeu time avançou, \033[31mPARABÉNS\033[m')
        print()
        ...
        if aleatorio_3 == 1:
            ...
            if aleatorio_4 == 1:
                print(f'\nO {time} venceu e está na \033[35mFINAL\033[m')
                print()
                ...
                if aleatorio_5 == 1:
                    ...
                    print('\nFoi por muito pouco, O \033[36mSANTOS É O CAMPEÃO\033[m')
            elif aleatorio_4 == 2:
            ...
            if aleatorio_4 == 1:
                ...
                if aleatorio_5 == 1:
                    ...
                    print('\nFoi por muito pouco, O \033[36mPALMEIRAS É O CAMPEÃO\033[m')
            elif aleatorio_4 == 2:
                print('Mais sorte na próxima...')
        elif aleatorio_3 == 3:
        ...
        print('\nSeu time foi eliminado, \033[31mTENTE NA PRÓXIMA\033[m')
elif confronto == 2:
    print('\033[37mSorteando confronto das quartas...\033[m')
    sleep(0.5)
    print(f'\n{time} x Santos')
        ...
        if aleatorio_3 == 1:
            ...
            if aleatorio_4 == 1:
                ...
                if aleatorio_5 == 1:
                    ...
                    print('\nFoi por muito pouco, O \033[36mINTERNACIONAL É O CAMPEÃO\033[m')
            elif aleatorio_4 == 2:
            ...
            if aleatorio_4 == 1:
                ...
                if aleatorio_5 == 1:
                    ...
                    print('\nFoi por muito pouco, O \033[36mBAHIA É O CAMPEÃO\033[m')
            elif aleatorio_4 == 2:
                print('\nMais sorte na próxima...')
        elif aleatorio_3 == 3:
            print(f'\n{time} x River Plate')
            ...
            if aleatorio_4 == 1:
                ...
                if aleatorio_5 == 1:
                    ...
                    print('\nFoi por muito pouco, O \033[36mFLUMINENSE É O CAMPEÃO\033[m')
            elif aleatorio_4 == 2:
                print('\nMais sorte na próxima...')
    elif aleatorio_2 == 2:
        print('\bSeu time foi eliminado, \033[31mTENTE NA PRÓXIMA\033[m')
elif confronto == 3:
    print('\033[37mSorteando confronto das quartas...\033[m')
    sleep(0.5)
    print(f'\n{time} x Fluminense')
    ...
    if aleatorio_2 == 1:
        ...
        if aleatorio_3 == 1:
            ...
            if aleatorio_4 == 1:
                ...
                print()
                print(f'\nA final será entre \033[34m{time} x Boca Juniors\033[m')
                print()
                print('EQUIPES ENFRENTANDO-SE...')
                sleep(0.5)
                aleatorio_5 = randint(1, 2)
                if aleatorio_5 == 1:
                    ...
                    print('\nFoi por muito pouco, O \033[36mBOCA JUNIORS É O CAMPEÃO\033[m')
            elif aleatorio_4 == 2:
                print('\nMais sorte na próxima...')
        elif aleatorio_3 == 2:
        ...
        if aleatorio_3 == 1:
            ...
            if aleatorio_4 == 1:
                ...
                if aleatorio_5 == 1:
                    ...
                    print('\nFoi por muito pouco, O \033[36mRIVER PLATE É O CAMPEÃO\033[m')
            elif aleatorio_4 == 2:
                print('\nMais sorte na próxima...')
        elif aleatorio_3 == 3:
            print(f'\n{time} x Santos')
